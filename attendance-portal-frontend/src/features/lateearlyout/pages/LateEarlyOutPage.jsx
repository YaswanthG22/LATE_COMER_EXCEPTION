...
import useLateEarlyOut from "../hooks/useLateEarlyOut";

const LateEarlyOutPage = () => {
  const vm = useLateEarlyOut();

  return (
    <div className="empdash">
      <div className="container-fluid px-3">
        <h1 className="text-center mb-4 text-primary">
          Late / Early Out Exception
        </h1>
...
export default LateEarlyOutPage;
